...
Config.Locations = {
  ...
  ["vehiclereturn"] = {
    label = "Tow truck return location",
    coords = vector3(1764.1, 3310.07, 41.16),
  },
  ["dropoff"] = {
    label = "Vehicle drop off location",
    coords = vector3(1769.09, 3342.27, 41.16)
  },
  ["towspots"] = {
    [1] =  {model = "sultanrs", coords = vector3(-405.61, 1212.17, 325.64)},
    [2] =  {model = "faction", coords = vector3(-2543.28, 2345.78, 33.06)},
    [3] =  {model = "oracle", coords = vector3(-1123.74, 2676.05, 18.28)},
    [4] =  {model = "chino", coords = vector3(343.67, 3412.38, 36.59)},
    [5] =  {model = "kanjo", coords = vector3(214.94, 1239.62, 225.46)},
    [6] =  {model = "stanier", coords = vector3(2673.82, 1682.67, 24.49)},
    [7] =  {model = "surfer2", coords = vector3(2541.95, 2610.58, 37.94)},
    ...
    [11] = {model = "dominator7", coords = vector3(884.37, 2839.1, 56.54)},
    [12] = {model = "dilettante", coords = vector3(584.5, 2789.15, 42.19)},
    ...
    [17] = {model = "gauntlet", coords = vector3(2579.5, 428.12, 108.46)},
    [18] = {model = "rebel", coords = vector3(2014.39, 3070.37, 47.07)},
    [19] = {model = "bfinjection", coords = vector3(1713.57, 3600.36, 35.17)},
    [20] = {model = "buffalo", coords = vector3(1712.16, 3777.36, 34.51)},
    [21] = {model = "rebel", coords = vector3(1346.65, 3605.04, 34.9)},
    [22] = {model = "ingot", coords = vector3(914.07, 3610.42, 32.81)},
    [23] = {model = "previon", coords = vector3(87.5, 3620.75, 39.78)},
    [24] = {model = "cheburek", coords = vector3(371.17, 4423.38, 62.44)},
    [25] = {model = "rumpo", coords = vector3(1691.42, 4766.71, 41.92)},
    [26] = {model = "chino", coords = vector3(3299.78, 5151.49, 18.27)},
    [27] = {model = "emporer2", coords = vector3(2200.49, 5616.55, 53.94)},
    [28] = {model = "stanier", coords = vector3(2601.27, 5303.45, 44.65)},
    [29] = {model = "burrito3", coords = vector3(1719.94, 6409.6, 33.92)},
    [30] = {model = "asea", coords = vector3(1417.57, 6594.58, 12.64)},
    [31] = {model = "fq2", coords = vector3(145.36, 6602.02, 31.85)},
    [32] = {model = "tornado3", coords = vector3(-88.45, 6554.8, 31.49)},
    [33] = {model = "primo", coords = vector3(-151.79, 6358.82, 31.49)},
    ...
    [38] = {model = "tornado3", coords = vector3(-2259.58, 4291.12, 46.78)},
